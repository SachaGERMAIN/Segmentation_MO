...
from MO.dataset_test import testDataset
...
train_data,val_data=random_split(data,lengths=[0.6,0.4])
...
for epoch in range(num_epochs):
    ...
    for images, masks,_,_ in loop_val:
        ...
        tp, fp, fn, tn = smp.metrics.get_stats(output.argmax(dim=1,keepdim=True), masks, mode='multilabel', threshold=0.5)
